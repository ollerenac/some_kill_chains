...
List:    GET  /api/challenge/all/wargame-challenge?pageNum=1&pageSize=200&...
...
LIST_URL  = (
    ...
    + "?pageNum=1&pageSize=200&sortBy=TITLE&enabledStatus=ENABLED&language=EN"
)
...
def build_pdf(rows: list[dict], out_path: str) -> None:
    ...
    subtitle = Paragraph(
        f"Total: {len(rows)} challenges  |  Source: {BASE_URL}  |  Categories: Cryptography, Forensics, "
        "ISMS, Malware, Reversing, System Hacking, Web Hacking",
